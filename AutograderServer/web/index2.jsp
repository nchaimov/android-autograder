...
<html>
<body>
<form action="/autograder/multigraderservlet" method="post" enctype="multipart/form-data">
<table><tr>
...
<tr><td>Upload your APK files to test:</td>
<td><input type="file" name="datasize" size="30" multiple="multiple"></td>
</tr>
<!-- <p>Activity:
...
<tr><td></td>
<td><input type="submit" value="Test all files!"></td><td></td>
</tr></table>
</form>
</body>
</html>